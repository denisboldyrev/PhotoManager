...
namespace PhotoManager.Infrastructure.Migrations.Migrations
{
    ...
    [Migration("20210818112204_EditAlbumCover")]
    partial class EditAlbumCover
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhotoManager.Core.Models.AlbumCover", b =>
                {
            ...
            modelBuilder.Entity("PhotoManager.Core.Models.AlbumCover", b =>
                {
                    b.HasOne("PhotoManager.Core.Models.Album", "Album")
                        .WithOne("Cover")
                        .HasForeignKey("PhotoManager.Core.Models.AlbumCover", "AlbumId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PhotoManager.Core.Models.Photo", "Photo")
                        .WithOne("AlbumCover")
                        .HasForeignKey("PhotoManager.Core.Models.AlbumCover", "PhotoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
